...
class fsk(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_range = Range(0, samp_rate/8, samp_rate/1000, Rb*8, 200)
        ...
        labels = ['I-Signal (p4b)', 'Q-signal (p4b)', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        labels = ['Modulating Signal (p4)', 'RF Modulated signal', 'Signal 3', 'Signal 4', 'Signal 5',
            'Signal 6', 'Signal 7', 'Signal 8', 'Signal 9', 'Signal 10']
        widths = [4, 2, 1, 1, 1,
            1, 1, 1, 1, 1]
        colors = ['blue', 'red', 'green', 'black', 'cyan',
