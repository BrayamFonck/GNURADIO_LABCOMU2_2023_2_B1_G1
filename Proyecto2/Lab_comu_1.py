...
import Lab_comu_1_epy_block_0 as epy_block_0  # embedded python block
...
class Lab_comu_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._frequency_range = Range(0, 1000, 10, 100, 200)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_f((1,2,3,4), True, 1, [])
        self._amplitude_range = Range(0, 5, 1, 1, 200)
