...
class flujograma(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.blocks_add_xx_0_0, 0), (self.digital_constellation_decoder_cb_0, 0))
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0, 0), (self.blocks_add_xx_0_0, 1))
